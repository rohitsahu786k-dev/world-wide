...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: site.url,
    siteName: site.name,
    images: [{ url: "/banner-img/worldwide-supply-28-sl/desktop/worldwide-supply-28-sl-luxury-products-banner-desktop-01.png", width: 1200, height: 630, alt: "Worldwide Supply 28 SL international luxury wholesale" }],
    type: "website",
  },
  icons: {
    icon: [
